defmodule RangerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RangerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RangerWeb.Gettext, "errors", msg, opts)
    end
  end
